    ...
    >
      ...
      >
        ...
        <Section title='8. AI-Generated Content'>
          ...
          <UL
            items={[
              'AI-generated plans are provided for informational purposes only and do not constitute professional medical or fitness advice',
              'You should consult a qualified healthcare provider or certified personal trainer before beginning any new exercise or nutrition programme, especially if you have pre-existing health conditions',
              'AI-generated content may contain errors or may not be appropriate for your specific circumstances',
              'We are not liable for any injury, illness, or adverse outcome resulting from following AI-generated plans',
            ]}
          />
        </Section>
